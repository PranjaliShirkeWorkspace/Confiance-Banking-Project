...
<%@page import="com.bank.entity.Accounts"%>
    ...
    <body id="body">
        ...
        <main class="site-content" role="main">
            ...
            <section> <div>
				<form action="checkIfPayeeExists.bank">
		...
		<label> Enter Payee Account Number: </label>
		<input type="text" name="payeeAccountNo" 
		pattern="[0-9]+" title="Enter valid number" required> 
