...
<%@page import="com.bank.entity.Transactions"%>
	...
	<div class="container">
		<form action="fixedDeposit.bank" method="post">
			...
			Principal Amount: 
			<input id="principalAmount" name="principalAmount" pattern="[0-9]+" required> 
			<br /> 
			Rate of Interest: 6% <br />
			Tenure(Up to 20 Years): <input id="tenure" type="number" name="tenure" min="1" max="20" required> Years 
			<br /> 
			Frequency: Annually <br />
			<br /> 
			Amount on maturity Annually is : <input style="border: none" name="maturityValue" id="result1" readonly>
			<br />
			Interest Earned on maturity Annually is : 
			<input style="border: none" name="interestEarned" id="result2" readonly> 
			
			<input onclick="calculateInterest()" type="submit" value="Create fixed deposit"
