...
<!-- preloader -->
        ...
        <main class="site-content" role="main">
            ...
            <div class="container">
		<form action="change.bank" method="post">
			<div class="col-lg-6" style="float:left;width:500px">
				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td><input type="password" name="existingPassword" required></td>
					...
					<tr>
						...
						<td><input type="password" name="newPassword" id="password"  onkeyup='check();' required></td>
	...
	<div id="message" style="float:right">
		...
		<p id="character" class="invalid">
			A <b>Atleast 1 Character</b>
		</p>
		<p id="letter" class="invalid">
			A <b>Atleast 1 Lowercase</b> letter
		</p>
		<p id="capital" class="invalid">
			A <b>Atleast 1 Uppercase</b> letter
		</p>
		<p id="number" class="invalid">
			A <b>Atleast 1 Number</b>
		</p>
