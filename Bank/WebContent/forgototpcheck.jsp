...
<%@page import="com.bank.entity.Transactions"%>
    ...
    <body id="body">
        ...
        <main class="site-content" role="main">
            ...
            <form action="checkotpforgotpass.bank">
<div class="alert-info">${Info}</div>
<input type="text" style="display:none;" name="phoneNo" value="${Phone}">
<input type="text" style="display:none;" name="genValue" value="${GenNo}">
Enter OTP : 
<input type="text"  name="entValue"required>
<input type="submit">
