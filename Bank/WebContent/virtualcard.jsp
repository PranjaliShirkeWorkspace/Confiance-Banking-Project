...
<body id="body">
	...
	<section>
		<div>
			...
			<form action="gencard.bank" method="post">

				<!-- First, Display Account number/Name of user by using session -->
				<!-- Then tell User to fill below details -->
				Enter your 4 digit PIN : <input type="password" name="pin" id="pin"
					onkeyup='check();' pattern="[0-9]+{4} "
					title="Enter valid four digit pin" required> <br>
				Confirm your PIN : <input type="password" name="confirmPin"
					id="confirmPin" onkeyup='check();' pattern="[0-9]+{4} " required><br>
				<span id='message1'></span> <input type="submit" name="submit"
			...
			<script>
				var check = function() {
					if (document.getElementById('pin').value == document
							.getElementById('confirmPin').value) {
