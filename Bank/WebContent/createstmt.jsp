...
<script>
	...
	/* $j_custom(function() {
		$j_custom(".datepick").datepicker({
			maxDate : '0'
		});
	}); */
	$j_custom(document).ready(
			function() {
				$j_custom("#start_date").datepicker(
						{
							changeMonth : true,
							maxDate : new Date(),
							onSelect : function(date) {
								...
								$j_custom("#end_date").datepicker("option",
										"minDate", endDate);
								$j_custom("#end_date").datepicker("option",
										"maxDate", '+2y');
...
table {
    ...
    <body id="body">
        ...
        <main class="site-content" role="main">
            ...
            <div class="container">
		<form action="createstmt.bank" method="post">
			<table class="table table-bordered">
				<tr>
					<td align="left">Start Date:</td>
					<td align="left"><input type="text" class="datepick"
						name="start_date" id="start_date" required /></td>
				</tr>
				<tr>
					<td align="left">End Date:</td>
					<td align="left"><input type="text" class="datepick"
						name="end_date" id="end_date" required /></td>
				</tr>
				<tr>
