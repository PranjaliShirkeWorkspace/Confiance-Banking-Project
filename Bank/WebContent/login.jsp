            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul  class="nav navbar-nav">
                        ...
                        <li><a href="index.jsp#service">Fund Transfer</a></li>
                        <li><a href="index.jsp#portfolio">Fixed Deposit</a></li>
                        <li><a href="index.jsp#testimonials">Virtual Card</a></li>
                        <li><a href="index.jsp#price">Statement</a></li>
		...
		<div class="col-lg-6">
			...
			<tr>
					...
					<td><input type="text" name="email"
						...
						title="Enter valid mail id of the format - 'abc@somemail.com' " required></td>
                    ...
                    <div class="row text-center">
                        <div class="footer-content">
                            <div class="wow animated fadeInDown">
                                <p style="color:white">newsletter signup</p>
