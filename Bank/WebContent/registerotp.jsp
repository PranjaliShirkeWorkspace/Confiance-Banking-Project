...
<%@page import="com.bank.entity.Transactions"%>
    ...
    <body id="body">
        ...
        <main class="site-content" role="main">
            ...
            <form action="checkOtp.bank">
	<%Aadhaar aadhaar=(Aadhaar)session.getAttribute("AADHAAR"); %>
		<div id="welcomeDiv"  class="answer_list">
		<input type="text" name="aadhaarNumber" style="display: none;" value="<%= aadhaar.getAadhaarNo() %>" required>
			<input type="text" name="generatedValue" style="display: none;" value="${Info}">
			Enter OTP : <input type="text" name="enteredValue" pattern="[0-9]+" title="Enter valid OTP" required> 
