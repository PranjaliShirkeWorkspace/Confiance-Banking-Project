...
<!-- preloader -->
            ...
            <div class="container" style="background-color:transparent">
                <div class="navbar-header">
					...
					<h1 class="navbar-brand">
						<a href="dashboard.jsp#body" style="color:white">CONFIANCE BANK</a>
					</h1>
					<!-- /logo -->
                </div>
        ...
        <main class="site-content" role="main">
            ...
            <div>
	<div class="container" style="width: 500px; float: left; margin-left: 20px">
		<form action="createaccount.bank" method="post">
			<div class="col-lg-6" style="width: 450px;">
				...
				<table class="table table-hover">
					<tr style="display: none;">
						<!-- style="display: none;" -->
						<%
							Aadhaar aadhaar = (Aadhaar) session.getAttribute("AADHAAR");
						%>
						<td>Enter Aadhaar Number :</td>
						<td><input type="text" name="aadhaarNumber"
							value="<%=aadhaar.getAadhaarNo()%>" required></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>City :</td>
						<td><%=aadhaar.getCity()%></td>

					</tr>
					<tr>

						<td>Phone Number :</td>
						<td><%=aadhaar.getPhoneNo()%></td>

					</tr>
					<tr>

						<td>Pin Code :</td>
						<td><%=aadhaar.getPincode()%></td>
					...
					<tr>
						...
						<td><input type="text" name="panNo"
							...
							title="Enter valid 10 digit Pan Card" required></td>
					...
					<tr>
						...
						<td><input type="text" name="email"
							...
							title="Enter valid mail id of the format - 'abc@somemail.com' "
							required></td>
					...
					<tr>
						...
						<td><input type="password" id="password" name="password"
							pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,14}$"
							title="8 to 14 characters which contain at least one lowercase letter, one uppercase letter, 
							one numeric digit, and one special character" onkeyup='check();'
							required></td>
					...
					<tr>
						...
						<td><input type="password" name="confirmPassword" id="confirmPassword" onkeyup='check();' required>
						<span id='message1'></span></td>
	...
	<div id="message" style="width: 350px; float: right;margin-top:15%">
