            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <ul  class="nav navbar-nav">
                        ...
                        <li><a href="dashboard.jsp#contact">Contact</a></li>
                    </ul>
                </nav>
                <!-- /main nav -->
                
                <nav class="collapse navbar-collapse navbar-right" role="navigation" style="font-size: 5px;">
                        <div class="row">
                            <ul class="nav navbar-nav">
                                ...
                                <li style="font-size: 5px;"><a>Account Number:<%=user.getAccountNo()%></a></li>
                                
                                
                                
                                <li><a>Balance:<%=user.getBalance()%></a></li>
...
<form action="http://192.168.100.198:8180/Bank/process.bank">
<input type="hidden" name="upi" value="123456789012">
