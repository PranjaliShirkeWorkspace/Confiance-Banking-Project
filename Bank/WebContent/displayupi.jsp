...
<%@page import="com.bank.entity.Transactions"%>
    ...
    <body id="body">
		...
		<table>
			<tr>
				<td colspan="2" class="alert-info">${message}</td>
			</tr>
		</table>

	</div>
	<form action="transferUpi.bank" method="get">


		<input type="radio" name="payeeUpi" value="${Payee.upi}" required>
		${Payee.upi}
		${Payee.accountHolderName}<br> 
		
		<label> Enter the amount</label>
		<input type="text" name="amount" pattern="[0-9]+" 
		title="Enter valid amount" required> 
