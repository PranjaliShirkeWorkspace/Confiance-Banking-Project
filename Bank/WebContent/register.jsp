...
<body id="body">
		...
		<div class="container">
			<div class="navbar-header">
				...
				<h1 class="navbar-brand">
					<a href="index.jsp#body" style="color:white">CONFIANCE BANK</a>
				</h1>
				<!-- /logo -->
			</div>
	...
	<section>
		<div align="center"> Enter Your Aadhaar Number Below</div>
	</section>
	<div class="alert-info">${Info}</div>
	<section>
	<div align="center">
	<form action="register.bank" method="post" align="center">
		<div class="col-lg-6">
			<table class="table table-hover">
				<tr>
					...
					<td><input type="text" name="aadhaarNumber"
						pattern="[0-9]{12}" title="Enter valid 12 digit Aadhar Number"
						required></td>
                    ...
                    <div class="row text-center">
						...
						class="subscribe-form wow animated fadeInUp">
                                <div class="input-field">
                                    <input type="email"
								class="subscribe form-control" placeholder="Enter Your Email...">
                                    <button type="submit"
								class="submit-icon">
                                        <i
                            ...
                            <div class="footer-social">
								...
								href="#"><i class="fa fa-thumbs-up fa-3x"></i></a></li>
                                    <li class="wow animated zoomIn"
								data-wow-delay="0.3s"><a href="#"><i
									class="fa fa-twitter fa-3x"></i></a></li>
                                    <li class="wow animated zoomIn"
								data-wow-delay="0.6s"><a href="#"><i
									class="fa fa-skype fa-3x"></i></a></li>
                                    <li class="wow animated zoomIn"
								data-wow-delay="0.9s"><a href="#"><i
									class="fa fa-dribbble fa-3x"></i></a></li>
                                    <li class="wow animated zoomIn"
								data-wow-delay="1.2s"><a href="#"><i
