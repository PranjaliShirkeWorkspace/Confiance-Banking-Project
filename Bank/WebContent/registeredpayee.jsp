...
<head>
 ...
 <table>
              <tr><td colspan="2" class="alert-info">${message}</td></tr>
              </table>
...
<form action="fundTransfer.bank" method="get">
			...
			<c:forEach items="${Payees}" var="payee" >
				...
				<input type="radio" name="payeeSrNo" value="${payee.srNo } " required>
			 ${payee.payeeName }  <br>	
			</c:forEach>
		...
		<label> you can enter the purpose for this payment so later you can remember it while viewing your Statement</label><br>
		<input type="text" name="message">
		<input type="submit" value="submit">

</form>

<a href="addPayee.jsp">Register a Payee?</a>
