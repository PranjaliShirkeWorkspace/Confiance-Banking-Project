...
public class FixedDepositController {
	...
	public String createFixedDepo(FixedDepoBean fixedDepoBean, Map model, HttpSession session) {
		...
		if (user.getBalance() > fixedDepoBean.getPrincipalAmount()) {
			...
			fixedDeposit.setMaturityValue(fixedDepoService.calculateMaturityValue(fixedDepoBean.getPrincipalAmount(),
					fixedDepoBean.getTenure()));
			...
			model.put("startDate",
					fixedDepoBean.getStartDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
	...
	@RequestMapping(value = "fetchFixedDeposits.bank")
	...
	@RequestMapping(value = "deletefd.bank", method = RequestMethod.POST)
	public String deleteFixedDeposits(@RequestParam("deleteMe") String deleteMe, Map model, HttpSession session) {
